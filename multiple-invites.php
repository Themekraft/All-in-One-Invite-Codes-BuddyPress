...
<?php $all_in_one_invite_codes_buddypress = get_option('all_in_one_invite_codes_buddypress');
...
<?php else: ?>
    <?php _e( 'Create  Multiple Invite Codes has been disabled. Contact the Administrator.', 'all_in_one_invite_codes-buddypress' ); ?>
